...
function uSwitchGridInit () {
  ...
  if(!uSwitchGridObj.style) {
	...
	gridContainer.innerHTML += '<div id="uswitch-grid-dashboard" style="position:fixed;right:20px;bottom:20px;padding:5px 10px;color:#fff;background:rgba(255,0,0,0.8);font-weight:bold;">' + uSwitchGridObj.style + ' v' + uSwitchGridObj.version + '</div>';
